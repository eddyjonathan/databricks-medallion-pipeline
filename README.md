...
Goals: 
  ...
  3- Build Gold layer objects: a stored aggregate table, a view, and data quality checks on the Silver output. The 2026 syllabus adds explicit data quality validation.
